...
require_once '../model/AudienciaShort.entity.php';
...
class AudienciaModel {
  ...
  public function getAudiencias() {
    ...
    try {
      $sql = "SELECT a.idaudiencia, CONCAT(p.codigo, ' ', p.tipo) as proceso, a.tipo, a.fecha, a.hora, a.edificio, a.sala, CONCAT(p2.nombres, ' ', p2.apellidos) as nombre, r.nombre as cargo
FROM audiencia as a
...
WHERE php2.rol_idrol IN (1,3) AND a.fecha >= NOW()";
