      ...
      <form class="formulario" method="post" action="procesar.php">
        ...
        <div class="descripcion-caso tarjeta bg-white">
          ...
          <textarea name="descripcion" id="descripcion" rows=" 10"
                    placeholder="Audicencia del proceso PENAL por el delito de acidente de tránsito en la ciudad de Loja, primera audiencia de formulación de cargos y medidas precautelares...."></textarea>
        </div>
